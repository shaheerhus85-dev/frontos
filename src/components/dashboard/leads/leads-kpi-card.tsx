...
import type { LeadsKpi } from "@/data/leads";
...
type LeadsKpiCardProps = Readonly<{
  className?: string;
  metric: LeadsKpi;
}>;

export function LeadsKpiCard({ className, metric }: LeadsKpiCardProps) {
  const Icon = icons[metric.icon];

  return (
    <Card
      data-testid={`leads-kpi-${metric.id}`}
