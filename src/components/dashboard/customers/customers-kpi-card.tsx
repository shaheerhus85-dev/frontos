...
import type { CustomersKpi } from "@/data/customers";
...
type CustomersKpiCardProps = Readonly<{
  className?: string;
  metric: CustomersKpi;
}>;

export function CustomersKpiCard({ className, metric }: CustomersKpiCardProps) {
  const Icon = icons[metric.icon];

  return (
    <Card
      data-testid={`customers-kpi-${metric.id}`}
