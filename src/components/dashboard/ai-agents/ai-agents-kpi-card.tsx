import { Bot, CheckCheck, Gauge, WandSparkles } from "lucide-react";

import { Card } from "@/components/ui/card";
import type { AgentKpi } from "@/data/ai-agents";
...
export function AIAgentsKpiCard({
  className,
  metric,
}: Readonly<{ className?: string; metric: AgentKpi }>) {
  const Icon = icons[metric.id];

  return (
    <Card
      data-testid={`ai-agents-kpi-${metric.id}`}
